...
author: "Bharadwaj Janarthanan | 1005068720 | bharadwaj@cs.toronto.edu"
...
save(nyt_review_dat,file="./NYT_Moview_Review_Data.RData")
...
save(nyt_review_articles,file="NYT_Review_Article_Content.RData")
```
...
for(year in year_range){
  ...
  save(bodat,file=paste("./BODat_",year_start,"_",year_end,".RData",sep=""))
...
boxoffice_dat$movie<-ifelse(boxoffice_dat$movie=="Kit Kittredge: An American .",
                            ...
                            ifelse(boxoffice_dat$movie=="Big Mommas: Like Father, Li.",
                                   ...
                                   ifelse(boxoffice_dat$movie=="The Oogieloves in the BIG B.",
                                          ...
                                          boxoffice_dat$movie)))
save(boxoffice_dat,file="./BO_Full_Dat.RData")
```
...
```{r, eval=FALSE, echo=FALSE}
load(url("https://github.com/bharat92/STA2453_Project1/blob/master/BO_Full_Dat.RData?raw=true"))
load(url("https://github.com/bharat92/STA2453_Project1/blob/master/NYT_Moview_Review_Data.RData?raw=true"))
load(url("https://github.com/bharat92/STA2453_Project1/blob/master/NYT_Review_Article_Content.RData?raw=true"))
load(url("https://github.com/bharat92/STA2453_Project1/blob/master/OMDB_Movie_Data.RData?raw=true"))
...
save(bo_filterfornyt_dat,file="./BO_NYT_Merged_Dat.RData")
...
save(omdb_movies_dat,file="./OMDB_Movie_Data.RData")
...
save(bo_filterfornyt_dat,file="./BO_NYT_OMDB_Merged_Dat.RData")
```
...
load(url("https://github.com/bharat92/STA2453_Project1/blob/master/BO_NYT_OMDB_Merged_Dat.RData?raw=true"))
load(url("https://github.com/bharat92/STA2453_Project1/blob/master/NYT_Review_Article_Content.RData?raw=true"))
...
save(bo_slope_dat,file="./BO_Slope_DaysVsRevenue.RData")
...
save(nyt_summarized_review_score_dat,file="./NYT_Review_SentimentScore.RData")
...
save(bo_summary_genres_dat,file="./Genes_Summary.RData")
...
save(lang_bo_dat,file="./Languages_Summary.RData")
...
save(summary_bo_rating_dat,file="./MPAA_Ratings_Summary.RData")
...
save(bo_summary_actors_dat,file="./Actors_Summary.RData")
...
save(releasetime_summary_dat,file="./Release_Time_Summary.RData")
...
save(theatre_summary_dat,file="./Theatre_Summary.RData")
...
save(rating_summary_dat,file="./Agent_Ratings.RData")
...
save(model_data,file="./Modelling_Data.RData")
```
...
```{r,echo=FALSE}
load(url("https://github.com/bharat92/STA2453_Project1/blob/master/BO_Slope_DaysVsRevenue.RData?raw=true"))
...
load(url("https://github.com/bharat92/STA2453_Project1/blob/master/NYT_Review_SentimentScore.RData?raw=true"))
...
save(tdm,file=paste0("./TDM_",sentiment_i,".RData"))
}
```
```{r, echo=FALSE}
load(url("https://github.com/bharat92/STA2453_Project1/blob/master/TDM_Neutral.RData?raw=true"))
neutral<-tdm

load(url("https://github.com/bharat92/STA2453_Project1/blob/master/TDM_Positive.RData?raw=true"))
positive<-tdm

load(url("https://github.com/bharat92/STA2453_Project1/blob/master/TDM_Negative.RData?raw=true"))
negative<-tdm
...
load(url("https://github.com/bharat92/STA2453_Project1/blob/master/Genes_Summary.RData?raw=true"))
...
load(url("https://github.com/bharat92/STA2453_Project1/blob/master/Languages_Summary.RData?raw=true"))
...
load(url("https://github.com/bharat92/STA2453_Project1/blob/master/MPAA_Ratings_Summary.RData?raw=true"))
...
load(url("https://github.com/bharat92/STA2453_Project1/blob/master/Actors_Summary.RData?raw=true"))
...
load(url("https://github.com/bharat92/STA2453_Project1/blob/master/Release_Time_Summary.RData?raw=true"))
...
```{r}
load(url("https://github.com/bharat92/STA2453_Project1/blob/master/Theatre_Summary.RData?raw=true"))
...
load(url("https://github.com/bharat92/STA2453_Project1/blob/master/Agent_Ratings.RData?raw=true"))
...
```{r}
load(url("https://github.com/bharat92/STA2453_Project1/blob/master/Modelling_Data.RData?raw=true"))
model_data<-model_data%>%
